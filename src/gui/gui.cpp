...
void gui::CreateImGui() noexcept {
	...
	gui::calibri = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\calibri.ttf", 15.f);
...
void gui::Render() noexcept {
	...
	ImGui::PushFont(gui::calibri);

	ImGui::Begin("Cartman", &exit, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
